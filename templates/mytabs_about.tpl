...
<div style='line-height: 16px; font-weight: bold;'>
    <{$smarty.const._AB_MYTABS_BY}> <{$module_author_name}>
</div>
...
<{if $module_credits}>
    <table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
        <tr>
            <td class='bg3'><b><{$smarty.const._AB_MYTABS_DEVELOPER_CREDITS}></b></td>
        </tr>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td colspan='2' class='bg3'>
            <b><{$smarty.const._AB_MYTABS_AUTHOR_INFO}></b>
        </td>
    </tr>

    <{if $module_developer_lead}>
        <tr>
            <td class='head' width='150px'><{$smarty.const._AB_MYTABS_DEVELOPER_LEAD}></td>
    ...
    <{if $module_developer_contributor}>
        <tr>
            <td class='head' width='150px'><{$smarty.const._AB_MYTABS_DEVELOPER_CONTRIBUTOR}></td>
    ...
    <{if $module_people_developers}>
        <tr>
            <td class='head' style="vertical-align: top;"
                width='150px'><{$smarty.const._AB_MYTABS_PEOPLE_DEVELOPERS}></td>
            <td class='even'>
    ...
    <{if $module_people_testers}>
        <tr>
            <td class='head' style="vertical-align: top;" width='150px'><{$smarty.const._AB_MYTABS_PEOPLE_TESTERS}></td>
            <td class='even'>
    ...
    <{if $module_people_translaters}>
        <tr>
            <td class='head' style="vertical-align: top;"
                width='150px'><{$smarty.const._AB_MYTABS_PEOPLE_TRANSLATERS}></td>
            <td class='even'>
    ...
    <{if $module_people_documenters}>
        <tr>
            <td class='head' style="vertical-align: top;"
                width='150px'><{$smarty.const._AB_MYTABS_PEOPLE_DOCUMENTERS}></td>
            <td class='even'>
    ...
    <{if $module_people_other}>
        <tr>
            <td class='head' style="vertical-align: top;" width='150px'><{$smarty.const._AB_MYTABS_PEOPLE_OTHER}></td>
            <td class='even'>
    ...
    <{if $module_developer_website_url}>
        <tr>
            <td class='head' width='150px'><{$smarty.const._AB_MYTABS_DEVELOPER_WEBSITE}></td>
    ...
    <{if $module_developer_email}>
        <tr>
            <td class='head' width='150px'><{$smarty.const._AB_MYTABS_DEVELOPER_EMAIL}></td>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td colspan='2' class='bg3'><b><{$smarty.const._AB_MYTABS_MODULE_INFO}></b></td>
    </tr>

    <tr>
        <td class='head' width='200px'><{$smarty.const._AB_MYTABS_MODULE_RELEASE_DATE}></td>
        <td class='even'><{$module_date}></td>
    </tr>

    <tr>
        <td class='head' width='200px'><{$smarty.const._AB_MYTABS_MODULE_STATUS}></td>
        <td class='even'><{$module_status}></td>
    </tr>

    <{if $module_demo_site_name}>
        <tr>
            <td class='head' width='200px'><{$smarty.const._AB_MYTABS_MODULE_DEMO}></td>
    ...
    <{if $module_support_site_name}>
        <tr>
            <td class='head' width='200px'><{$smarty.const._AB_MYTABS_MODULE_SUPPORT}></td>
    ...
    <{if $module_submit_bug}>
        <tr>
            <td class='head' width='200px'><{$smarty.const._AB_MYTABS_MODULE_BUG}></td>
            <td class='even'><a href="<{$module_submit_bug}>"
                                target="_blank"><{$smarty.const._AB_MYTABS_MODULE_SUBMIT_BUG}></a></td>
        </tr>
    <{/if}>

    <{if $module_submit_feature}>
        <tr>
            <td class='head' width='200px'><{$smarty.const._AB_MYTABS_MODULE_FEATURE}></td>
            <td class='even'><a href="<{$module_submit_feature}>"
                                target="_blank"><{$smarty.const._AB_MYTABS_MODULE_SUBMIT_FEATURE}></a></td>
        </tr>
    <{/if}>
</table>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td class='bg3'><b><{$smarty.const._AB_MYTABS_MODULE_DISCLAIMER}></b></td>
    </tr>
...
<{if $module_author_word}>
    <table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
        <tr>
            <td class='bg3'><b><{$smarty.const._AB_MYTABS_AUTHOR_WORD}></b></td>
        </tr>
...
<table width='100%' cellspacing="1" cellpadding="3" border="0" class="outer" style="margin-top: 15px;">
    <tr>
        <td class='bg3'><b><{$smarty.const._AB_MYTABS_VERSION_HISTORY}></b></td>
    </tr>
