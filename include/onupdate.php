 ...
 */
function xoops_module_pre_update_mytabs(XoopsModule $module)
{
...
function xoops_module_update_mytabs(XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Mytabs\Helper $helper */
    /** @var Mytabs\Utility $utility */
    /** @var Mytabs\Configurator $configurator */
    $helper  = Mytabs\Helper::getInstance();
    $utility = new Mytabs\Utility();
    $configurator = new Mytabs\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'mytabsx_categories';
        $column     = 'ordre';
        $newName    = 'order';
